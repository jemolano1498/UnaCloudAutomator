...
public abstract class Platform {
     ...
     */
    private String executablePath = "/usr/lib/virtualbox/VBoxManage";
     ...
     */
    public abstract void startExecution(String imageName) throws PlatformOperationException;
     ...
     */
    public abstract void stopExecution(String imageName);
     ...
     * @throws PlatformOperationException
     */
    public abstract void executeCommandOnExecution(String image, String command,String...args) throws PlatformOperationException;
     ...
     * @throws PlatformOperationException
     */
    public abstract void copyFileOnExecution(String image,String destinationRoute, File sourceFile) throws PlatformOperationException;
    ...
    public abstract void unregisterImage(String image);
    
    public abstract void cloneImage(String sourceImg, String destImg);
    
//    public void stopAndUnregister(ImageCopy image){
//    	synchronized (image) {
//    		stopExecution(image.getImageName());
